-- data/storify_plugin_paths.lua
local DataStorage = require("datastorage")
local ffiUtil = (pcall(require, "ffi/util") and require("ffi/util")) or (pcall(require, "ffiutil") and require("ffiutil")) or require("ffiUtil")
local lfs = (pcall(require, "libs/libkoreader-lfs") and require("libs/libkoreader-lfs")) or require("lfs")
...
-- directory is the one kept, since downstream code builds
...
-- StorifySettings key for the user's per-path hide/show preference (an
...
-- written to.
--
-- config_override: string|nil  -- `plugin_install_path` from configuration
-- remembered_path:  string|nil -- previously remembered choice (StorifySettings)
